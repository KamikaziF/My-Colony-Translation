(function(window, document){
    window.appStrings = {
        "es": {
            "app_name":                            "My Colony",
            "new-game-message":         "Comandante - Acabamos de aterrizar y estamos listos para empezar una nueva colonia . ¿Como lo llamamos ?",
            "welcome-message":          "¡Bienvenido!  Acabas de fundar una nueva colonia con el código colonial de #motherland.  Tu misión es de convertir este planeta desolado en una civilización próspera.  Para empezar, selecciona tu rover y ordenalo a que empiece a recolectar.  Una vez que hayas recolectado al menos 5 Mineral, selecciona la nave y construye otro rover.",
            "rover-description":        "El rover es el el robot básico de trabajo para la colonia.  Puede minar minerales y construir estructuras básicas.",
            "lander-description":       "Aterrizastes aquí en él.",
            "mine-description":         "Extrae mineral crudo del suelo.  Utiliza los rovers para recolectar el Mineral.",
            "pavement-description":     "Hace que tu colonia se vea bonito.  Acelera a los vehículos con ruedas.",
            "greenhouse-description":   "Una estructura básica para crecer para la colonia.",
            "silo-description":         "Almacena la comida vital que se necesita para la colonia.",
            "atmosgen-description":     "Un edificio pequeño que lentamente genera cantidades reastrables de atmósfera, para empezar a terraformar tu planeta.",
            "factory-description":      "Una fábrica pequeña que puede fabricar varios vehículos de tamaño medio.  También genera pequeñas cantidades de atmósfera y ruedas lentamente.",
            "builder-description":      "Este pequeño e increíble robot ayudará a empezar a construir tu colonia!",
            "beta-info":                "My Colony es un nuevo juego de simulación y estrategia de construcción de colonias que está de momento en una temprana etapa de beta.  Actualmente no hay un objetivo en el juego, ¡pero por favor juegalo y luego vaya a la comunidad del forum con opiniones y sugerencias en cosas que pueda añadir esto para que sea un juego de colonización completamente funcional!",
            "lander-sell-warning":      "No te estoy intentando a enseñar a jugar este juego, pero generalmente no es una buena idea vender la nave hasta que tengas la suficiente confianza de que no lo necesitas.  Es la única manera de recolectar mineral al principio, ¡Y no puedes construir otro! ¿Estás seguro de que lo quieres vender?",
            "refinery-description":     "Una instalación que convierte mineral crudo en acero refinado que se necesita en proyectos de construcción avanzadas. Requiere trabajadores para operar.",
            "miner-description":        "Este robot puede recoger mineral de la superficie y transportarla a una refinería.  También puede cavar una mina de mineral.",
            "small-panel-description":  "Genera una cantidad modesta de electricidad para la colonia sin la necesidad de añadir más cosas.",
            "landing-pad-description":  "Una vez que hayas construido una plataforma de aterrizaje, nuevos colonos llegarán periódicamente a tu colonia.",
            "small-shelter-description":"Una básica vivienda para colonos.  Da refugio a 3 colonos.",
            "chop-shop-description":    "Coge viejos rovers y poco usados y lo desguazan en materias primas.",
            "goldminer-description":    "Extrae oro y lo transporta a la refinería de oro.",
            "goldrefinery-description": "Convierte oro áspero extraído del suelo a oro puro.",
            "goldsmelter-description":  "Convierte el oro refinado en dinero puro y duro.",
            "hire-button-change-job":   "Cambiar trabajo",
            "hire-button-hire":         "Contratar ",
            "object-sell":              "Vender ",
            "object-remove":            "Quitar",
            "side-menu-game-data":      "Datos del juego",
            "delete-game-confirm":      ".¿Estás seguro de eliminar tu colonia?",
            "header-delete-colony":     "Eliminar Colonia",
            "tax-window-header":        "Impuestos de #motherland ",
            "tax-window-content":       "La Asamblea General de #motherland está satisfecha de informarte que su exitosa colonia debe de pagar impuestos a la gente de #motherland.",
            "tax-window-owed-header":   "Impuestos a pagar: ",
            "tax-window-pay":           "Pagar",
            "tax-window-reject":        "Evadir impuestos",
            "tax-window-pay-response":  "La gente de #motherland te agradece por su contribución a la sociedad.",
            "tax-window-reject-response": "La Asamblea General de #motherland le gustaría recordar que el cumplimiento de la ley es mandatorio.  Re Visitaremos esto más tarde.",
            "adv-hydro-desc":           "Desbloquea técnicas avanzadas de crecer comida hidropónicamente.",
            "hd-solar-desc":            "Un panel solar mejorado, la tecnología que puede generar más energía sobre el mismo superficie .",
            "smalllab-description":     "¡Crea un pequeño equipo para llevar a cabo increíbles experimentos y desbloquear nuevas tecnologías!",
            "advancedhydro-description":"Una instalación de alta tecnología for para crecer grandes cantidades de comida.  Requiere trabajadores para operar.",
            "solar-tower-description":  "Una torre con alta densidad de paneles solares.  Provisiona una buena cantidad de energía y deja una huella mínima .",
            "adv-ore-pur-desc":         "Descubre métodos avanzados para refinar mineral crudo en puro acero.",
            "builder2-description":     "Es un robot constructor para crear más estructuras complejas.",
            "construction-2-desc":      "Desbloquea métodos de construcción avanzadas for para crear nuevas estructuras y vehículos.",
            "pavement2-description":    "Pavimento extraduro, endurecido con acero.  Caro, pero permite ir muy rápido en vehículos.",
            "silo2-description":        "Un silo que guarda grandes cantidades de comida para tus colonos.",
            "finance-theory-desc":      "Investiga las teorías y métodos detrás del dinero y las financias y como se aplica a las colonias espaciales.",
            "refinery2-description":    "Convierte mineral a acero rápidamente y casi 5 veces más eficiente que la refinería de mineral normal.  Requiere trabajadores para producir.",
            "adv-gold-desc":            "Permite la construcción y excavación de nuevas minas de oro.",
            "goldmine-description":     "Cava una nueva mina de oro para extraer Oro áspero desde el suelo.",
            "rescomplex-description":   "Proporciona viviendas de tamaño mediano para 26 colonos.",
            "greendome-description":    "Una bóveda verde ofrece recreación y entretenimiento gratis para tus colonos, para que no se vuelvan locos.",
            "massdriver-description":   "Una catapulta electromagnética avanzada de alta energía que te permite lanzar bienes a #motherland por dinero.  Requiere trabajadores, también genera una pequeña cantidad de dinero por su cuenta.",
            "lg-manufacturing-desc":    "Desbloquea la habilidad de manufacturar bienes de consumo en los entornos hostiles de tu colonia.",
            "chipfactory-description":  "La fábrica de microchips emplea a 26 trabajadores y convierte Oro áspero en Microchips .",
            "tax-payment-thankyou":     "#motherland te agradece por su obediencia.",
            "tax-payment-insufficient": "Su paga de impuestos a la Asamblea General de #motherland es insuficiente.  Los puntos en su saldo están acusados.",
            "stage-1-intro":            "¡La atmósfera planetaria es ahora suficientemente gruesa para soportar vida básica de microbios!",
            "stage-2-intro":            "A medida que la atmósfera planetaria crece, pequeñas plantas empiezan a brotar del suelo.",
            "stage-3-intro":            "Los niveles de la atmósfera ahora son similares a los de la Tierra, ¡permitiendo la actividad regular al aire libre!",
            "col-civics-desc":          "¡Empieza a crear un gobierno colonial, construya estructuras cívicas, y promulgue leyes para su gente!",
            "atmosgen2-description":    "Un generador de atmósfera más eficiente y de alta potencia.",
            "civiccenter-description":  "Empieza a construir tu gobierno colonial con el centro cívico. Cuesta dinero y requiere trabajadores para operar. Genera el recurso 'Cívico' .",
            "statue1-description":      "Dedicado a los valientes colonos quienes fueron los primeros en pisar este planeta .",
            "fracking-description":     "Un método de alta tecnología y alta energía para extraer Mineral del suelo, sin la necesidad de un minero de Mineral.  Requiere trabajadores y energía.",
            "adv-chem-desc":            "Descubre los secretos de transformar cosas en otras cosas con la ciencia de la química .",
            "gldsynth-description":     "¡Un pequeño laboratorio que puede convertir mineral crudo en oro áspero!  Requiere trabajadores y mucha energía.",
            "la-zoology-desc":          "Empieza el desarrollo temprano el la cría de vida silvestre en condiciones de atmósfera bajas.",
            "hatchery-description":     "Cultiva deliciosos peces para el consumo de colonos.  Les Poissons!",
            "icechipper-description":   "Un rover pequeño pero ágil que puede recolectar depósitos de hielo y volver con agua para la colonia.",
            "waterbot-description":     "Un rover pequeño pero ágil que puede recolectar depósitos de hielo y volver con agua para la colonia.",
            "atmoscondensor-description":"Extrae atmósfera del aire y condénsalo en agua puro.",
            "pet-expansion-desc":       "Compra tierra colonial concedido de la Asamblea General de #motherland para expandir tu colonia.",
            "pet-annex-desc":           "Expande el territorio colonial sin el consentimiento de la Asamblea General de #motherland . Puede provocar una respuesta hostil.",
            "smalltank-description":    "Guarda y distribuye agua fresca para a tus colonos.",
            "waterpump-description":    "Bombea y filtra pequeñas cantidades de agua fresca por debajo de la superficie del planeta.",
            "aluminumrefinery-description":"Construye Mineros de Aluminio y recolecta depósitos de aluminio en bruto.",
            "watertower-description":   "Almacena grandes cantidades de agua para mantener la sed de tus colonos bien satisfechos",
            "adv-microbio-desc":        "Estudia los secretos de cultivar organismos viviente en ambientes de niveles de atmósfera bajas.",
            "new-game":                 "Nuevo Juego",
            "new-game-col-name":        "Nombre de la colonia",
            "custom-map-name":          "Nombre del mapa",
            "map-size-header":          "Tamaño del Mapa",
            "map-size-small":           "Pequeño",
            "map-size-medium":          "Medio",
            "map-size-large":           "Grande",
            "resources-header":         "Recursos",
            "resources-scarce":         "Escasos",
            "resources-normal":         "Normal",
            "resources-abundant":       "Abundantes",
            "nuke-physics-desc":        "Aprende a cómo recolectar y refinar Uranio para hacer energía nuclear en un ambiente de baja atmósfera",
            "uraniumminer-description": "Recolecta depósitos de uranio y transporta el material radiactivo a la planta nuclear.",
            "nuclearplant-description": "Convierte y refina uranio puro en electricidad para tu colonia.",
            "bacteriafarm-description": "Empieza a criar formas de vida microbiana que genera atmósfera para la colonia.",
            "greenbot-description":     "Un constructor que puede construir estructuras relacionadas con la agricultura.",
            "firtrees-description":     "Estos abetos nobles pueden crecer bien en ambientes de baja atmósfera.  Pueden ser decorativos, o pueden ser talados por madera.",
            "engine-keyboard":          "Controles de teclado",
            "engine-keyboard-meta":     "Personalizar atajos de teclado para el juego.",
            "general-cancel":           "Cancelar",
            "keyboard-clear-menus":     "Limpiar los Mensajes Activos",
            "keyboard-idle-unit":       "Buscar vehículos desocupado",
            "keyboard-sell-noconf":     "Vender edificio sin confirmación",
            "hold-and-click-tip":       "Mantener la combinación de teclas y selecciona el edificio.",
            "keyboard-upgrade-noconf":  "Mejorar edificio sin confirmación",
            "when-object-selected":     "Activar objeto al seleccionarlo",
            "keyboard-move-unit":       "Mover unidad activa",
            "keyboard-harvest-mode":    "Activar modo recolección",
            "keyboard-show-build":      "Enseñar modos de construcción",
            "keyboard-show-export":     "Enseñar opciones de exportación",
            "keyboard-show-import":     "Enseñar opciones de importación",
            "keyboard-sell":            "Vender objeto activo",
            "keyboard-upgrade":         "Mejorar objeto activo",
            "keyboard-defaults":        "Restaurar por defectos",
            "keyboard-defaults-warn":   "¡Borrará todos los enlaces personalizados!",
            "keyboard-cancel-nocon":    "Cancelar construcción sin confirmación",
            "keyboard-cancel":          "Cancelar construcción",
            "general-move":             "Mover",
            "general-harvest":          "Recolectar",
            "general-build":            "Construir",
            "general-upgrade":          "Mejorar",
            "general-import":           "Importar",
            "general-export":           "Exportar",
            "general-dismiss":          "Descartar",
            "medicalclinic-description":"Brinda a los colonos servicios de restauración de la salud..",
            "general-park-unit":        "Apacar",
            "general-park-confirm":     "Zona de aparcamiento asignado",
            "engine-sidebar":           "Interfaz de barra lateral",
            "tax-window-trade-embargo": "¡Por continuar fallando a pagar los impuestos a la gente de #motherland, La Asamblea General de #motherland está imponiendo un embargo comercial a tu colonia!",
            "tax-window-lift-embargo":  "La Asamblea General #motherland ha levantado gentilmente el embargo comercial contra tu colonia.",
            "tax-window-img-embargo":   "Debido a las deterioradas relaciones entre tu colonia y la gente de #motherland, ¡La Asamblea General de  #motherland está imponiendo una congelación migratoria completa contra su colonia!",
            "tax-window-img-lift":      "La Asamblea General de  #motherland ha restaurado tentativamente la inmigración a tu colonia.",
            "wall-description":         "Amuralla áreas para decorar o para organizar tu colonia y guía a los bots.",
            "lumbermill-description":   "Procesa los árboles en el recurso Madera.",
            "lumberbot-description":    "¡Esta práctica cosechadora puede talar árboles y plantar árboles nuevos!",
            "sfhouse-description":      "¡Coge a la esposa y a los niños y mudate a esta casa de madera nostálgica de una familia!",
            "megabot-description":      "Un constructor resistente para proyectos de construcciones de gran escala.",
            "urenrich-description":     "Representando una hazaña increíble de ingeniería y ciencia, estas instalaciones pueden duplicar el poder del Uranio.  Requiere mucha energía y un flujo constante de Aluminio.",
            "lgwatertower-description": "Una torre gigante de agua que mantiene muchísima agua.  ¿Qué más se puede decir?",
            "largeres-description":     "Estructura de viviendas de alta densidad..  No es la mas lujosa, pero alberga a mucha gente baratamente.",
            "indepence-noafford":       "No puedes permitirte independizarte de #motherland.",
            "independence-general":     "Independencia",
            "general-united-earth":     "Organización de la Tierra Unidad",
            "relations-header":         "Relaciones de #motherland",
            "foundation-header":        "Fundado por",
